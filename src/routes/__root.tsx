...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "SOLENA is a luxury growth studio building gravity for culture, capital, and legacy.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "SOLENA",
          description:
            "Luxury growth studio building gravity for culture, capital, spaces, ventures, and legacy institutions.",
          url: "/",
        }),
      },
    ],
